...
1. Refer to command_to_build.txt for the specific PyInstaller build commands. <details><summary>Click to view command_to_build.txt (Command to run) file contents</summary>```txt
